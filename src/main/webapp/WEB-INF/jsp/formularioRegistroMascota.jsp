...
<div class="form-container glass-panel">
    ...
    <form:form action="/mascotas/guardar" modelAttribute="mascota" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-section">
            <h3 class="text-gradient">Información de la Mascota</h3>
            ...
            <div class="radio-group">
                <label><form:radiobutton path="sexo" value="Macho" /> Macho</label>
                <label><form:radiobutton path="sexo" value="Hembra" /> Hembra</label>
            </div>
        ...
        <div style="text-align: center; margin-top: 30px;">
            <a href="/home" style="color: var(--secondary); text-decoration: none; font-size: 1rem; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">◀ Volver al Panel Principal</a>
        </div>
    </form:form>
</div>
