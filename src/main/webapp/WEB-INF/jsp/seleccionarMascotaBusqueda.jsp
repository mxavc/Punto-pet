    ...
    <div class="form-container glass-panel" style="text-align: center;">
        <c:choose>
            <c:when test="${empty mascotas}">
                ...
                <a href="${pageContext.request.contextPath}/mascotas/registro" class="btn-nav" style="background: linear-gradient(135deg, #FF3366, #FF6B6B);">➕ Registrar nueva Mascota</a>
            </c:when>
            <c:otherwise>
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    <c:forEach var="mascota" items="${mascotas}">
                        <a href="${pageContext.request.contextPath}/parejas/filtros?mascotaId=${mascota.id}" class="btn-nav" style="background: rgba(32, 227, 178, 0.2); border: 1px solid var(--secondary); color: white; transition: all 0.3s;">
        ...
        <div style="margin-top: 40px;">
            <a href="${pageContext.request.contextPath}/home" style="color: var(--danger); text-decoration: none; font-size: 1rem; font-weight: 600; text-transform: uppercase;">Cancelar</a>
        </div>
    </div>
</body>
</html>
